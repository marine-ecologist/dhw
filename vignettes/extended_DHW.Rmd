...
ningaloo_OISST_cell_dhw_6 <- calculate_dhw(ningaloo_OISST_cell_hotspots, window = 6*7) 
ningaloo_OISST_cell_dhw_8 <- calculate_dhw(ningaloo_OISST_cell_hotspots, window=8*7) 
ningaloo_OISST_cell_dhw_10 <- calculate_dhw(ningaloo_OISST_cell_hotspots, window=10*7) 
ningaloo_OISST_cell_dhw_12 <- calculate_dhw(ningaloo_OISST_cell_hotspots, window=12*7) 
ningaloo_OISST_cell_dhw_14 <- calculate_dhw(ningaloo_OISST_cell_hotspots, window=16*7) 
ningaloo_OISST_cell_dhw_16 <- calculate_dhw(ningaloo_OISST_cell_hotspots, window=20*7) 


ningaloo_OISST_dhw_lag <- rbind(
  data.frame(time=as.Date(time(ningaloo_OISST_cell_dhw_6)), dhw=as.vector(values(ningaloo_OISST_cell_dhw_6))) |> mutate(windowlength="6 weeks"),
  data.frame(time=as.Date(time(ningaloo_OISST_cell_dhw_8)), dhw=as.vector(values(ningaloo_OISST_cell_dhw_8))) |> mutate(windowlength="8 weeks"),
  data.frame(time=as.Date(time(ningaloo_OISST_cell_dhw_10)), dhw=as.vector(values(ningaloo_OISST_cell_dhw_10))) |> mutate(windowlength="10 weeks"),
  data.frame(time=as.Date(time(ningaloo_OISST_cell_dhw_12)), dhw=as.vector(values(ningaloo_OISST_cell_dhw_12))) |> mutate(windowlength="12 weeks"),
  data.frame(time=as.Date(time(ningaloo_OISST_cell_dhw_14)), dhw=as.vector(values(ningaloo_OISST_cell_dhw_14))) |> mutate(windowlength="14 weeks"),
  data.frame(time=as.Date(time(ningaloo_OISST_cell_dhw_16)), dhw=as.vector(values(ningaloo_OISST_cell_dhw_16))) |> mutate(windowlength="16 weeks")) |> 
...
ningaloo_OISST_cell_anom_0.0 <- calculate_hotspots(ningaloo_OISST_cell_mmm, ningaloo_OISST_cell, anomaly=0) |> 
  calculate_dhw(anomaly=0)
ningaloo_OISST_cell_anom_0.5 <- calculate_hotspots(ningaloo_OISST_cell_mmm, ningaloo_OISST_cell, anomaly=0.5) |> calculate_dhw(anomaly=0.5)
ningaloo_OISST_cell_anom_1.0 <- calculate_hotspots(ningaloo_OISST_cell_mmm, ningaloo_OISST_cell, anomaly=1) |> 
  calculate_dhw(anomaly=1)
ningaloo_OISST_cell_anom_1.5 <- calculate_hotspots(ningaloo_OISST_cell_mmm, ningaloo_OISST_cell, anomaly=1.5) |>
  calculate_dhw(anomaly=1.5)
ningaloo_OISST_cell_anom_2.0 <- calculate_hotspots(ningaloo_OISST_cell_mmm, ningaloo_OISST_cell, anomaly=2) |> 
  calculate_dhw(anomaly=2)


ningaloo_OISST_dhw_anomalies <- rbind(
  data.frame(time=as.Date(time(ningaloo_OISST_cell_anom_0.0)), 
             dhw=as.vector(values(ningaloo_OISST_cell_anom_0.0))) |> mutate(anomaly="0 anom"),
  data.frame(time=as.Date(time(ningaloo_OISST_cell_anom_0.5)), 
             dhw=as.vector(values(ningaloo_OISST_cell_anom_0.5))) |> mutate(anomaly="0.5 anom"),
  data.frame(time=as.Date(time(ningaloo_OISST_cell_anom_1.0)), 
             dhw=as.vector(values(ningaloo_OISST_cell_anom_1.0))) |> mutate(anomaly="1.0 anom"),
  data.frame(time=as.Date(time(ningaloo_OISST_cell_anom_1.5)), 
             dhw=as.vector(values(ningaloo_OISST_cell_anom_1.5))) |> mutate(anomaly="1.5 anom"),
  data.frame(time=as.Date(time(ningaloo_OISST_cell_anom_2.0)), 
             dhw=as.vector(values(ningaloo_OISST_cell_anom_2.0))) |> mutate(anomaly="2.0 anom")) |> 
  mutate(year = year(time), month = month(time), day=day(time)) |> 
...
ggplot() + theme_bw() + ggtitle("2011 event") +
  facet_wrap(~season_anchor, ncol=2) +
  geom_line(aes(reference_date, dhw, group=anomaly, color=anomaly), show.legend=FALSE) + 
